        ...
        {trackDays.map((td) => (
          <div key={td.id} className="card trackday-item">
            <div className="trackday-info">
              ...
              <div>
                <div className="trackday-nome">{td.local}</div>
                <div className="trackday-cidade">{td.cidade}</div>
              </div>
            </div>

            <div className="trackday-stats">
              <div className="trackday-stat">
                <span className="trackday-stat-label">Data</span>
                <span className="trackday-stat-value">{td.data}</span>
              </div>

              <div className="trackday-stat">
                <span className="trackday-stat-label">Clima</span>
              ...
              <div className="trackday-stat">
                <span className="trackday-stat-label">Sessões</span>
                <span className="trackday-stat-value">
              ...
              <div className="trackday-stat trackday-melhor-volta">
                <div>
                  ...
                  <span className="trackday-stat-value">{td.melhorVolta}</span>
                </div>
                <span
                  className={`trackday-variacao ${td.variacaoPositiva ? 'positiva' : 'negativa'}`}
                >
                  {td.variacao}
                </span>
              </div>
